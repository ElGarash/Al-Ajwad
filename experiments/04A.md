...
<span style="color: #888888;"> _Table_04A3_: Validation results using epoch-5.</span>

|                                                    | Minshawy_Murattal_128kbps (WER %) | Yasser_Ad-Dussary_128kbps (WER %) |
| -------------------------------------------------- | --------------------------------- | --------------------------------- |
| No augmentation (on the whole Quran)               |               12.20               |                8.03               |
| No augmentation (ayat duration < 30 seconds)       |               6.77                |                4.82               |
| Using augmentation (on the whole Quran)            |               19.18               |                19.04              |
| Using augmentation (ayat duration < 30 seconds)    |               15.21               |                16.48              |
...
- No augmentation (on the whole Quran): https://www.kaggle.com/omartarik612/real-all-validation-epoch-5

- No augmentation (ayat duration < 30 seconds): https://www.kaggle.com/omartariiik/real-validation-30-epoch-5

- Using augmentation (on the whole Quran): https://www.kaggle.com/omartariiik/augmented-real-validation-epoch-5

- Using augmentation (ayat duration < 30 seconds): https://www.kaggle.com/omartariq612/augmented-30-validation-epoch-5
...
- normal vanilla-small: https://www.kaggle.com/omartariq612/vanilla-small

- 0.85x vanilla-small: https://www.kaggle.com/omartariq612/stretch-0-85-small

- 1.15x vanilla-small: https://www.kaggle.com/omartariq612/stretch-1-15-small

- normal epoch-9: https://www.kaggle.com/omartariiik/whisper-epoch-9-new

- 0.85x epoch-9: https://www.kaggle.com/omartarik612/stretch-0-85-epoch-9

- 1.15x epoch-9: https://www.kaggle.com/omartarik612/stretch-1-15-epoch-9
