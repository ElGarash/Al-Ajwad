...
Notes: * [a, b]x means the `TimeStretch` effect is applied to the dataset with `min_rate = a` and `max_rate = b`.</span>

|                                     | Minshawy_Murattal_128kbps (x1) (WER %) | Yasser_Ad-Dussary_128kbps (x1) (WER %) | Minshawy_Murattal_128kbps [0.8, 1.5]x (WER %) | Yasser_Ad-Dussary_128kbps [0.7, 1.2]x (WER %) |
| ----------------------------------- | ---------------------------------------| -------------------------------------- | --------------------------------------------- | --------------------------------------------- |
