...
<span style="color: #888888;"> _Table_06A1_: (resample to 16000 Hz => TimeStretch).</span>
...
<span style="color: #888888;"> _Table_06A2_: (TimeStretch => resample to 16000 Hz).</span>
...
* It's clear that the order of resampling and augmentation affects the quality of the audio and the WER results.
 ...
 <p align="center">
    <span style="color: #888888;"><em>Figure 06A2</em>: Ayah Error Rate using <a href="https://huggingface.co/omartariq612/whisper-small-augmented-epoch-5">epoch-5</a>.</span>
 </p>
 <p align="center">
     <img src="./media/06A1.png" alt="ayah error rate">
 </p>

 <p align="center">
    <span style="color: #888888;"><em>Figure 06A2</em>: Word Error Rate using <a href="https://huggingface.co/omartariq612/whisper-small-augmented-epoch-5">epoch-5</a>.</span>
 </p>
 <p align="center">
     <img src="./media/06A2.png" alt="word error rate">
 </p>
...
* [[1](https://arxiv.org/abs/2307.14743)] tries to address this drawback:
    ...
    <p align="center">
        <img src="./media/06A3.png" alt="Whisper-Streaming">
    </p>
    ...
    ```
    <span style="color: #888888;"> _Table_06A3_: output.txt content</span>

    | Emission time from beginning of processing (in milliseconds) | Begining timestamp of the text segment (as estimated by Whisper model) (in milliseconds) | End timestamp of the text segment (as estimated by Whisper model) (in milliseconds) | Segment |
    | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------- |
