...
* It's needed to collect more samples for sorahs that their `WER` **is not in the first quartile**, for this purpose, the output of the [**sorahs-that-need-more-samples notebook**](https://www.kaggle.com/code/omartariq612/sorahs-that-need-more-samples) can be used.
...
* sorahs-that-need-more-samples notebook: https://www.kaggle.com/code/omartariq612/sorahs-that-need-more-samples
